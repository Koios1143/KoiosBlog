export const pagesRoutes = [
  ...
  ["v-6e6058d4","/posts/Google_Intern_Interview.html",{"d":1706486400000,"l":"January 29, 2024","c":["Feedbacks"],"g":["Interview","Google"],"e":"<h1> 2024 Google SWE Intern Interview 心得</h1>\n<p>大概在今年的一月初投了履歷到 Google SWE，希望暑假可以去累積累積經驗，大概在幾天後就收到要填寫面試時間的通知信件，三周後收到了面試的通知。</p>\n<p>在面試前收到的信件都會很貼心地說明，也有提供一些線上的資源協助你去了解如何準備面試，甚至也可以直接跟對方來往信件去確認，我覺得這一點是還蠻不錯的。</p>\n<p>面試的流程大致上會分成兩場，兩場都是針對算法題目，不太會對簡歷或是個人背景去做提問，結束前也會有一小段可以任意問問題的時間。</p>\n<p>兩場面試基本上會被放在同一天當中，但是會在不同時段。以我自己來說，我分別是在早上跟下午各一場。一場時間大概是 45 分鐘。</p>","y":"a","t":"2024 Google SWE Intern Interview 心得"},[":md"]],
  ...
  ["v-00be579c","/tag/interview/",{"y":"p","t":"Tag: Interview","I":false},[]],
  ["v-0060d308","/tag/google/",{"y":"p","t":"Tag: Google","I":false},[]],
]
